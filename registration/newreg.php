...
if ( isset($_POST['submit']) ) {
	...
	if ( empty($errors) == true ) {
	 	if ( move_uploaded_file($file_tmp, $target_dir . $photocopy) ) {
    		...
    		$lastInsertedEmpCode = mysqli_real_escape_string($db, $curEmpID);
    		header('location:'.REG_URL.'reports/'.$lastInsertedEmpCode.'/');
	...
	<div class="container">
		<div class="register-box">
		  	<div class="register-logo">
		    	<a href="<?php echo BASE_URL; ?>"></b> Mango Solutions EMS</a>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select class="form-control" id="identification" name="identification" required>
								...
								<option <?php echo $_POST['identification']=='National ID Card' ? 'selected' : ''; ?> value="National ID Card">National ID Card</option>
