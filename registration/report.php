...
<button type="button" class="btn btn-primary" onclick="redirectToHomepage()">Return to homepage</button>

<script>
  function redirectToHomepage() {
    // Replace 'your_homepage_url_here' with the URL of your homepage
...
<script>
  function redirectToHomepage() {
    // Replace 'your_homepage_url_here' with the URL of your homepage
    window.location.href = 'https://mangosolutions.gettexh.com';
  }
</script>
