...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
        			...
        			<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								...
								<button type="button" class="btn btn-xs btn-primary pull-right" onclick="document.location.href='../registration/'">
		...
		<strong> &copy; <?php echo date("Y");?> Mango Solutions EMS | </strong> Powered by: GETTEXH
		</footer>
	</div>
